...
def create_pdf(header_info, items_data, doc_type="question"):
    ...
    # [핵심] 여기서 인덱스(idx)를 사용해 번호를 강제로 생성합니다.
    for idx, item in enumerate(items_data):
        ...
        if doc_type == "question" and item.get('passage'):
            ...
            # 꽉 찬 너비가 아니라 번호 칸(8mm)을 뺀 82mm 사용
        ...
        story.append(Spacer(1, 6*mm)) # 문제 간 간격
        ...
        with st.spinner(f"AI({target_model_name})가 문제를 생성 중입니다..."):
            ...
            try:
                ...
                if parsed_data:
                    ...
                    st.success(f"✅ {len(parsed_data)}문항 출제 완료! (디자인: 100% 이그잼포유 스타일)")
                else:
